package com.uhubai.server.register;


import com.uhubai.server.config.RegistryConfig;
import com.uhubai.server.config.ServerConfig;
...
public class ServiceRegistry {
    ...
    private final String zkPath = "/rpc";
